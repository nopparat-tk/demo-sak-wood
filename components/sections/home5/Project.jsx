                     ...
                     <div className="item">
                        <div className="projects-three__single">
                           <div className="projects-three__img">
                              <img
                                 src="assets/images/ref/projects-3-1.jpg"
                                 alt=""
                              />
                              ...
                              <div className="projects-three__arrow">
                                 <Link
                                    href="assets/images/ref/projects-3-1.jpg"
                                    className="img-popup"
                                 >
                  ...
                  <SwiperSlide>
                     ...
                     <div className="item">
                        <div className="projects-three__single">
                           <div className="projects-three__img">
                              <img
                                 src="assets/images/ref/projects-3-2.jpg"
                                 alt=""
                              />
                              <div className="projects-three__content">
                                 <p className="projects-three__sub-title">
                              ...
                              <div className="projects-three__arrow">
                                 <Link
                                    href="assets/images/ref/projects-3-2.jpg"
                                    className="img-popup"
                                 >
                                    <span className="icon-up-right-arrow-1"></span>
                                 </Link>
                  ...
                  <SwiperSlide>
                     ...
                     <div className="item">
                        <div className="projects-three__single">
                           <div className="projects-three__img">
                              <img
                                 src="assets/images/ref/projects-3-4.jpg"
                                 alt=""
                              />
                              <div className="projects-three__content">
                                 <p className="projects-three__sub-title">
                              ...
                              <div className="projects-three__arrow">
                                 <Link
                                    href="assets/images/ref/projects-3-4.jpg"
                                    className="img-popup"
                                 >
                                    <span className="icon-up-right-arrow-1"></span>
                                 </Link>
                  ...
                  <SwiperSlide>
                     ...
                     <div className="item">
                        <div className="projects-three__single">
                           <div className="projects-three__img">
                              <img
                                 src="assets/images/ref/projects-3-3.jpg"
                                 alt=""
                              />
                              <div className="projects-three__content">
                                 <p className="projects-three__sub-title">
                              ...
                              <div className="projects-three__arrow">
                                 <Link
                                    href="assets/images/ref/projects-3-3.jpg"
                                    className="img-popup"
                                 >
                                    <span className="icon-up-right-arrow-1"></span>
                                 </Link>
