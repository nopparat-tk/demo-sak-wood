      ...
      <Layout headerStyle={2} footerStyle={1} breadcrumbTitle="About Us">
            ...
            <div className="row">
                ...
                <div className="services-four__single">
                  ...
                  <div className="services-four__content">
                    <h4 className="services-four__title">
                      <Link href="services">Reasonable Prices</Link>
                    </h4>
                    <p className="services-four__text">
                      As well as getting to fly to different dest as part of
                      their job, airplane pilots get big
                    </p>
                  </div>
              ...
              >
                <div className="services-four__single">
                  ...
                  <div className="services-four__content">
                    <h4 className="services-four__title">
                      <Link href="services">Reasonable Services</Link>
                    </h4>
                    <p className="services-four__text">
                      As well as getting to fly to different dest as part of
                      their job, airplane pilots get big
              ...
              >
                <div className="services-four__single">
                  ...
                  <div className="services-four__content">
                    <h4 className="services-four__title">
                      <Link href="services">360 PANORAMA & 3D</Link>
                    </h4>
                    <p className="services-four__text">
                      As well as getting to fly to different dest as part of
                      their job, airplane pilots get big
          ...
          <div className="container">
            <div className="row">
                ...
                >
                  <ul className="list-unstyled about-one__img-list">
                    ...
                    <li>
                      <div className="about-one__img">
                        <img
                          src="/assets/images/resources/about-one-1-2.jpg"
                          alt=""
                        />
                      </div>
                    </li>
              ...
              <div className="col-xl-7">
                <div
                  className="about-one__right wow fadeInLeft"
                  data-wow-delay="300ms"
                >
                  <div className="about-one__content">
                    <div
                      className="about-one__content-shape-1"
                      style={{
                        backgroundImage:
                          " url(/assets/images/shapes/about-one-content-shape-1.png)",
                      }}
                    ></div>
                    ...
                    <div className="about-one__design-make">
                      <div className="about-one__design-make-img">
                        <img
                          src="/assets/images/resources/about-one-design-make-img-1.jpg"
                          alt=""
                        />
                      </div>
                      <div className="about-one__design-make-content">
                        <h5 className="about-one__design-make-title">
                          Design Make Dream
                        </h5>
                        <p className="about-one__design-make-text">
                          Rapidiously evolve pandemic experiences
                          <br />
                  ...
                  <div className="projects-one__single">
                    <div className="projects-one__img-box">
                      <div className="projects-one__img">
                        <img
                          src="/assets/images/project/projects-1-1.jpg"
                          alt=""
                        />
                      </div>
                      <div className="projects-one__content">
                        <div
                          className="projects-one__content-shape-1"
                          style={{
                            backgroundImage:
                              " url(/assets/images/shapes/projects-one-content-shape-1.png)",
                          }}
                        ></div>
                        <h4 className="projects-one__title">
                          <Link href="#">Neoclassical Sofa</Link>
                        </h4>
                        <p className="projects-one__sub-title">
                          Interior Design
                        </p>
                      </div>
                      <div className="projects-one__arrow">
                        <Link
                          href="/assets/images/project/projects-1-1.jpg"
                          className="img-popup"
                        >
                ...
                <div className="col-xl-3 col-lg-6 col-md-6 filter-item anim ani">
                  <div className="projects-one__single">
                    <div className="projects-one__img-box">
                      <div className="projects-one__img">
                        <img
                          src="/assets/images/project/projects-1-2.jpg"
                          alt=""
                        />
                      </div>
                      <div className="projects-one__content">
                      ...
                      <div className="projects-one__arrow">
                        <Link
                          href="/assets/images/project/projects-1-2.jpg"
                          className="img-popup"
                        >
                          <span className="icon-up-right-arrow-1"></span>
                        </Link>
                ...
                <div className="col-xl-3 col-lg-6 col-md-6 filter-item des ani">
                  <div className="projects-one__single">
                    <div className="projects-one__img-box">
                      <div className="projects-one__img">
                        <img
                          src="/assets/images/project/projects-1-3.jpg"
                          alt=""
                        />
                      </div>
                      <div className="projects-one__content">
                      ...
                      <div className="projects-one__arrow">
                        <Link
                          href="/assets/images/project/projects-1-3.jpg"
                          className="img-popup"
                        >
                          <span className="icon-up-right-arrow-1"></span>
                        </Link>
                ...
                <div className="col-xl-3 col-lg-6 col-md-6 filter-item des ani nat">
                  <div className="projects-one__single">
                    <div className="projects-one__img-box">
                      <div className="projects-one__img">
                        <img
                          src="/assets/images/project/projects-1-4.jpg"
                          alt=""
                        />
                      </div>
                      <div className="projects-one__content">
                      ...
                      <div className="projects-one__arrow">
                        <Link
                          href="/assets/images/project/projects-1-4.jpg"
                          className="img-popup"
                        >
                          <span className="icon-up-right-arrow-1"></span>
                        </Link>
                ...
                <div className="team-one__sinlge">
                  ...
                  <div className="team-one__content">
                    ...
                    <h3 className="team-one__title">
                      <Link href="team-details">Jonathan S. Wilcox</Link>
                    </h3>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="team-one__sinlge">
                  ...
                  <div className="team-one__content">
                    ...
                    <p className="team-one__sub-title">Teka dibe bacchu</p>
                    <h3 className="team-one__title">
                      <Link href="team-details">Jessica Brown</Link>
                    </h3>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="team-one__sinlge">
                  ...
                  <div className="team-one__content">
                    ...
                    <p className="team-one__sub-title">Teka dibe bacchu</p>
                    <h3 className="team-one__title">
                      <Link href="team-details">Jonathan Trot</Link>
                    </h3>
                  </div>
                </div>
              </div>
        ...
        <section className="sliding-text-one">
          ...
          <div className="sliding-text-one__wrap">
            <ul className="sliding-text__list list-unstyled marquee_mode">
              ...
              <li>
                <h2 data-hover="luxury homes" className="sliding-text__title">
                  luxury homes
                  <img src="/assets/images/icon/star-icon.png" alt="" />
                </h2>
              </li>
              <li>
                <h2
                  data-hover="construction simulator"
                  className="sliding-text__title"
                >
                  ...
                  <div className="item">
                    <div className="testimonial-two__single">
                      ...
                      <h3 className="testimonial-two__name">
                        <Link href="testimonials">Michael Angenla</Link>
                      </h3>
                      <p className="testimonial-two__sub-title">
                        Project Manager
                      </p>
                      <p className="testimonial-two__text">
                        Divide carefully fruitsome sixth form beginning replenis
                        together midst lesser to airs there brought forth him
                        she us one seas can was void can be awrare were nots
                        multiply image female best project.
                      </p>
                    </div>
                  </div>
                ...
                <SwiperSlide>
                  ...
                  <div className="item">
                    <div className="testimonial-two__single">
                      ...
                      <h3 className="testimonial-two__name">
                        <Link href="testimonials">Brenda Gregory</Link>
                      </h3>
                ...
                <SwiperSlide>
                  ...
                  <div className="item">
                    <div className="testimonial-two__single">
                      ...
                      <h3 className="testimonial-two__name">
                        <Link href="testimonials">Edward Monroe</Link>
                      </h3>
                      <p className="testimonial-two__sub-title">
                        Senior Designer
                      </p>
                ...
                <SwiperSlide>
                  ...
                  <div className="item">
                    <div className="testimonial-two__single">
                      ...
                      <h3 className="testimonial-two__name">
                        <Link href="testimonials">Alisa Brown</Link>
                      </h3>
                      <p className="testimonial-two__sub-title">
                        Project Manager
                      </p>
                ...
                <SwiperSlide>
                  ...
                  <div className="item">
                    <div className="testimonial-two__single">
                      ...
                      <div className="testimonial-two__img">
                        <img
                          src="/assets/images/testimonial/testimonial-2-5.jpg"
                          alt=""
                        />
                      </div>
                      <div className="testimonial-two__shape-1">
                      ...
                      <h3 className="testimonial-two__name">
                        <Link href="testimonials">Brenda heyden</Link>
                      </h3>
                      <p className="testimonial-two__sub-title">CEO of Apple</p>
                      <p className="testimonial-two__text">
                        Divide carefully fruitsome sixth form beginning replenis
                ...
                <SwiperSlide>
                  ...
                  <div className="item">
                    <div className="testimonial-two__single">
                      ...
                      <div className="testimonial-two__img">
                        <img
                          src="/assets/images/testimonial/testimonial-2-6.jpg"
                          alt=""
                        />
                      </div>
                      <div className="testimonial-two__shape-1">
                      ...
                      <h3 className="testimonial-two__name">
                        <Link href="testimonials">Kark Edward</Link>
                      </h3>
                      <p className="testimonial-two__sub-title">
                        Senior Designer
                      </p>
        ...
        <section className="blog-two">
          ...
          <div className="container">
            <div className="section-title text-left sec-title-animation animation-style2">
              <h2 className="section-title__title title-animation">
                Unleash Your Creativity with <br /> Interior Inspiration
              </h2>
            </div>
            <BlogSlider />
          </div>
